"""
Parser para extractos PDF del ICBC Argentina
...
Formato típico:
  ...
  Pie:
    SALDO FINAL / SALDO AL DD/MM/AAAA:   XX.XXX,XX

Notas:
  - El formato ICBC es relativamente limpio y tabular.
  - Los encabezados pueden aparecer en inglés en algunos extractos
    (heredado del formato internacional del grupo ICBC).
  - Gastos: RETENCION SIRCREB, IMP.DB.CR.LEY 25413, COMISION, IVA,
    PERCEPCION IIBB, IMP.SELLOS, INTERESES DESCUBIERTO.
"""
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print("Uso: python parser_icbc.py <extracto.pdf>"); sys.exit(1)
